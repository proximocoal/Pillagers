...
class TestTown(unittest.TestCase):
    ...
    def setUp(self):
        self.test = Town(TestTown.most)

    def tearDown(self):
        del self.test

    def test_pillagers_init(self):
        self.assertEqual(self.test.pillagers, TestTown.initial)

    def test_defenders_init(self):
        self.assertEqual(self.test.defenders, TestTown.def_lowest)
    ...
    def test_most_init(self):
        self.assertEqual(self.test.most, TestTown.most)
    ...
    @unittest.mock.patch.object(Town, "roll_die", return_value=1)
    def test_pillage_abandoned_false(self, mock_roll):
        self.test.pillagers = 1
        self.test.abandoned = True
        self.assertEqual(self.test.pillage(), {})

    @unittest.mock.patch.object(Town, "roll_die", return_value=most//2+1)
    def test_pillage_abandoned_return(self, mock_roll):
        self.test.pillagers = 1
        self.test.abandoned = True
        self.assertEqual(self.test.pillage(), Town.pillage_value)
    ...
    @unittest.mock.patch.object(Town, "roll_die", return_value=most)
    ...
    @unittest.mock.patch.object(Town, "roll_die", return_value=2)
    ...
    @unittest.mock.patch.object(Town, "roll_die", return_value=3)
    ...
    @unittest.mock.patch.object(Town, "roll_die", return_value=1)
    @unittest.mock.patch.object(Town, "abandon")
    ...
    @unittest.mock.patch.object(Town, "check_defence")
    @unittest.mock.patch.object(Town, "pillage", return_value={})
    @unittest.mock.patch.object(Town, "check_abandon")
    @unittest.mock.patch.object(Town, "change_pillagers")
    @unittest.mock.patch.object(Town, "check_trade", return_value={})
    ...
    def test_check_trade_pass(self):
        self.test.pillagers = 1
        self.assertEqual(self.test.check_trade(), Town.trade_value)
